...
class ManagerCompanyServicesListView(
...
class ManagerCompanyServicesCreateView(
    LoginRequiredMixin,
    ManagerAccessMixin,
    SuccessMessageMixin,
    BaseListViewMixin,
    ...
    success_url = reverse_lazy("company_services:manager:list")
    ...
    def get_form_kwargs(self):
        kwargs = super(ManagerCompanyServicesCreateView, self).get_form_kwargs()
        kwargs.update({"created_by": self.request.user})
        return kwargs


class ManagerCompanyServicesDeleteView(
    LoginRequiredMixin,
    ManagerAccessMixin,
    SuccessMessageMixin,
    BaseListViewMixin,
...
class ManagerCompanyServicesUpdateView(
    LoginRequiredMixin,
    ManagerAccessMixin,
    SuccessMessageMixin,
    BaseListViewMixin,
    ...
    def get_form_kwargs(self):
        kwargs = super(ManagerCompanyServicesUpdateView, self).get_form_kwargs()
