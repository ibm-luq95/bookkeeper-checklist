 ...
 *   https://datatables.net/download/#bm/jq-3.6.0/dt-1.12.1/af-2.4.0/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/cr-1.5.6/fc-4.1.0/fh-3.2.4/r-2.3.0/sc-2.0.7/sl-1.4.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.12.1, AutoFill 2.4.0, Buttons 2.2.3, Column visibility 2.2.3, HTML5 export 2.2.3, ColReorder 1.5.6, FixedColumns 4.1.0, FixedHeader 3.2.4, Responsive 2.3.0, Scroller 2.0.7, Select 1.4.0
 */
...
*/
(function(b){"function"===typeof define&&define.amd?define(["jquery","datatables.net-bm","datatables.net-autofill"],function(a){return b(a,window,document)}):"object"===typeof exports?module.exports=function(a,c){a||(a=window);c&&c.fn.dataTable||(c=require("datatables.net-bm")(a,c).$);c.fn.dataTable.AutoFill||require("datatables.net-autofill")(a,c);return b(c,a,a.document)}:b(jQuery,window,document)})(function(b,a,c,d){b=b.fn.dataTable;b.AutoFill.classes.btn="button is-small";return b});
